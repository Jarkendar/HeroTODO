...
public class Bard extends Hero {
    ...
    public Bard(double strengthExperience, double endurancePoints, double dexterityPoints, double intelligencePoints, double wisdomPoints, double charismaPoints) {
