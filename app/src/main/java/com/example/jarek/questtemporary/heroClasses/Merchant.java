...
public class Merchant extends Hero  {
    ...
    public Merchant(double strengthExperience, double endurancePoints, double dexterityPoints, double intelligencePoints, double wisdomPoints, double charismaPoints) {
